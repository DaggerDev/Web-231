...
let warning = document.getElementById("warning"); // added variable for the warning box.
...
function runTheRegister() {
  ...
  try {
    ...
    warning.innerHTML = error; // created a variable on line 18 for the warning box and am changing the innerHTML here to display the error thrown on line 45.
  }
...
function calcChange(changeValue) {
   ...
   changeValue -= bill5Amt*5; // changed amount from 3 to 5 to fix bug with improper amount of subtraction causing extra $1 bills.
